(intro)=
# Lagoon Creek Tsunami Test Problem
...
- The [webpage to register](https://uoregon.zoom.us/meeting/register/MPpOdNUfRQqyg_X4zgwrFA#/registration)
...
and we would be happy to hear any feedback from your experiences.**

The *Lagoon Creek test problem* provides a specific location for modelers
to try out these sources and compare results with what others compute in
order to check that they are loading the sources properly, and to provide
feedback on the format being used.  The Lagoon Creek region in Northern
California is of interest due to paleotsunami evidence found here, collected
in part by members of the CRESCENT
Cascadia Paleoseismology Working Group,
[CPAL](https://cascadiaquakes.org/cpal/).
