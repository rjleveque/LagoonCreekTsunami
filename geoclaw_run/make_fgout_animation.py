...
if 1:
    # all frames:
    fgframes = range(fgframe1, nout+1)
else:
    # for testing on smaller set of frames:
    fgframes = range(fgframe1,nout+1,10)

# subset of times:
#fgframes = range(49,200,1)
#fgframes = range(49,152,5)
...
if __name__ == '__main__':
    ...
    # Output files:
    name = f'{event}_fgout{fgno:02d}_animation'
