...
#--------------------------
    ...
    #plotdata.file_prefix = 'fgout0001'  # for fgout grid on ocean
    #plotdata.file_prefix = 'fgout0001'  # for fgout grid on fgmax region
    ...
    plotaxes.aspect_latitude = 41.  # set aspect ratio based on this latitude
    ...
    #-----------------------------------------
    # Figure for surface around Lagoon Creek
    #-----------------------------------------

    plotfigure = plotdata.new_plotfigure(name='LagoonCreek', figno=1)
    ...
    plotaxes.xlimits = [-124.12, -124.087]
    plotaxes.ylimits = [41.578, 41.608]
